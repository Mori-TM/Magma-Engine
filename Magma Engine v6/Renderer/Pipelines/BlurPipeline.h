void CreateBlurRenderPass()
{
	...
	BlurRenderPass = OpenVkCreateRenderPass(1, ColorFormats, false, 0, false, 1, true);
}
...
{
	uint32_t ShaderAttributeFormats[] = { OPENVK_FORMAT_RG32F, OPENVK_FORMAT_RG32F };
	uint32_t ShaderAttributeOffsets[] = { 0, 8 };

	OpenVkGraphicsPipelineCreateInfo GraphicsPipelineCreateInfo;
	GraphicsPipelineCreateInfo.VertexShader = OpenVkReadFile("Data/Shader/BlurVertex.spv");
