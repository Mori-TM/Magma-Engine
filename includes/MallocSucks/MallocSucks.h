...
size_t s_AddBlock(size_t Size)
{
	...
	DefBlock.AllocatedElements = DynamicArrayCreate(sizeof(s_AllocatedElementInfo), Name);
...
void s_init()
{
	...
	s_MemBlocks = DynamicArrayCreate(sizeof(s_MemBlockInfo), "Malloc Sucks, Mem Blocks");
