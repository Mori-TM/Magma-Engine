	...
	ImGui::Begin("Scene");
	{
		ImGui::BeginChild("SceneRender");
		{
			...
			*/
			...
			ImGui::Image(&GetDescriptorSet(SceneRenderDescriptorSet)[VkRenderer.CurrentFrame], WindowSize);

		}
		ImGui::EndChild();
		
		IsEditorActive = ImGui::IsWindowFocused(ImGuiFocusedFlags_ChildWindows);
	}
	ImGui::End();
	ImGui::PopStyleVar();
}